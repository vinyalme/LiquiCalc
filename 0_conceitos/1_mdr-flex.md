...
## 🧪 **Simulador de MDR Flex**
O modelo **MDR Flex** foi implementado em três versões independentes de simulador, cada uma projetada para diferentes ambientes operacionais e perfis de uso. Todas seguem rigorosamente a lógica de cálculo apresentada neste documento, com base nas fórmulas oficiais de valor líquido, taxa flexível aplicada por transação e parâmetros configuráveis de ajuste.
...
- 🔗 [`teste_conceito_mdr-flex_1.1.md`](https://github.com/vinyalme/LiquiCalc/blob/main/2_testes/0_conceitos_teste/2_simulador_mdr-flex1.1v/teste_conceito_mdr-flex.md)
- 🔗 `teste_calculo_mdr-flex_2.1.md`
- 🔗 `teste_calculo_mdr-flex_3.1.md`
- 🔗 `teste_calculo_mdr-flex_4.1.md`
