...
│   │   │   └──📄 teste_conceito_mdr-padrao.md           # Teste conceitual da MDR padrão
│   │   ├── 📁 2_simulador_mdr-flex1.1v/
│   │   │   └──📄 teste_conceito_mdr-flex.md             # Teste conceitual da MDR flexível
│   │   └── 📁 3_simulador_antecipacao1.2v/
│   │       └──📄 teste_conceito_antecipacao.md          # Teste conceitual da antecipação de recebíveis
│   │
│   ├── 📁 1_excel_teste/                                # Simuladores em Excel para testes manuais e validação visual
│   │   ├── 📁 0_LiquiCalc.2.3v/                   
│   │   │   └── 📄 teste_calculo_liquicalc_2.3.md        # Teste de cálculo da versão consolidada 1.3
...
│   │   ├── 📁 0_LiquiCalc.3.3v/                       
│   │   │   └── 📄 teste_calculo_liquicalc_3.3.md        # Teste de cálculo da versão consolidada 2.3
│   │   ├── 📁 1_simulador_mdr-padrao3.0v/             
│   │   │   └── 📄 teste_calculo_mdr-padrao_3.0.md       # Teste de cálculo da MDR padrão versão 2.0
│   │   ├── 📁 2_simulador_mdr-flex3.1v/              
│   │   │   └── 📄 teste_calculo_mdr-flex_3.1.md         # Teste de cálculo da MDR flexível versão 2.1
│   │   └── 📁 3_simulador_antecipacao3.2v/            
│   │       └── 📄 teste_calculo_antecipacao_3.2.md      # Teste de cálculo da antecipação versão 2.2
│   │
│   └── 📁 3_calculadora-web_teste/                      # Interfaces web interativas para simulação dos cálculos via navegador
│       ├── 📁 0_LiquiCalc.4.3v/                       
│       │   └── 📄 teste_calculo_liquicalc_4.3.md        # Teste de cálculo da versão consolidada 3.3
│       ├── 📁 1_simulador_mdr-padrao4.0v/             
│       │   └── 📄 teste_calculo_mdr-padrao_4.0.md       # Teste de cálculo da MDR padrão versão 3.0
│       ├── 📁 2_simulador_mdr-flex4.1v/               
│       │   └── 📄 teste_calculo_mdr-flex_4.1.md         # Teste de cálculo da MDR flexível versão 3.1
│       └── 📁 3_simulador_antecipacao4.2v/            
...
| **Rel.2**       | [Protótipos em Excel](https://github.com/vinyalme/LiquiCalc/tree/main/1_simuladores/0_excel)       | Implementação dos Protótipos em Excel: tradução dos cálculos em planilhas individuais e versão consolidada                                            | 2.0.0 a 2.3.0    | 2 semanas      | Em andamento |
| **Rel.2.1**     | [Validação dos protótipos](https://github.com/vinyalme/LiquiCalc/tree/main/2_testes/1_excel_teste) | Testes Controlados Excel: validação dos resultados com dados reais e cálculos esperados                                                               | 2.0.1 a 2.3.1    | 1 dia          | Em andamento |
